...
export default function BoxSx({ content = {} }) {
  ...
  const {
    sectiontitle = "Vision",
    body = "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diamnonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat,sed diam voluptua.",
  } = content;
