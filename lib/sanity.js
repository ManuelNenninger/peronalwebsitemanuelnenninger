...
export const ptComponents = {
  ...
  block: {
    ...
    h2: ({children}) => <Typography variant="h2" sx={{fontWeight: "500"}} gutterBottom>{children}</Typography>,
    ...
    customHeading: ({children}) => {
      ...
      <>
        <Box sx={{display: {xs: "none", sm: "block"}}} >
          <Typography variant="h1" gutterBottom component="h1" sx={{fontWeight: "700"}}>{children}</Typography>
        </Box>
        <Box sx={{display: {xs: "block", sm: "none"}}} >
          <Typography variant="h2" component="h1" sx={{fontWeight: "700"}}>{children}</Typography>,
        </Box>
      </>)
    },
    customBoldText: ({children}) => {
      ...
      <>
        <Box sx={{display: {xs: "none", sm: "block"}}} >
          <Typography variant="h2" gutterBottom  sx={{fontWeight: "500"}}>{children}</Typography>
        </Box>
        <Box sx={{display: {xs: "block", sm: "none"}}} >
          <Typography variant="h3" component="h1" sx={{fontWeight: "500"}}>{children}</Typography>,
        </Box>
      </>)
    },
  },
  ...
  marks: {
    ...
    gradientText: ({children}) => {return <span className="gradientText">{children}</span>}
  },
}
